...
(setq user-full-name "Jonathan Conde"
      user-mail-address "mail@jonahanconde.com")
...
(map! 
 :leader
 (:prefix ("l" . "lorem ipsum")
  :desc "add lorem ipsum paragraph"
...
(setq org-todo-keywords
  ...
  (setq org-todo-keyword-faces
        (quote (("TODO" :foreground "coral" :weight bold)
                ...
                ("MEETING" :foreground "light salmon" :weight bold)
                ("PHONE" :foreground "cornflower blue" :weight bold)
                )))
...
(setq org-html-head-extra "<link rel=\"stylesheet\" href=\"https://jonathanconde.com/org.css\" type=\"text/css\" />")
